...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        WisataModel [] datawisata = new WisataModel[]{
                ...
                new WisataModel(R.drawable.waterboomjogja,"Waterboom Jogja", "Buka pukul 09.00 WIB", "Waterboom Jogja adalah alah satu waterpark terbesar di asia tenggara yang berlokasi di kota wisata terbesar kedua di Indonesia yaitu Yogyakarta.\\n\" +\n" +
                        "                        \"\\n\" +\n" +
                        "                        \"Waterboom Jogja telah tersertifikasi CHSE (Clean, Health, Safety, & Enviroment) dengan score 100% dari Kemenparekraf RI dan Sucofindo.", "Jenengan, Maguwoharjo, Sleman"),
